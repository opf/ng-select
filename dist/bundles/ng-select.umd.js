(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/forms'), require('rxjs/operators'), require('rxjs'), require('@angular/common'), require('@angular/core')) :
    typeof define === 'function' && define.amd ? define('@ng-select/ng-select', ['exports', '@angular/forms', 'rxjs/operators', 'rxjs', '@angular/common', '@angular/core'], factory) :
    (factory((global['ng-select'] = global['ng-select'] || {}, global['ng-select']['ng-select'] = {}),global.ng.forms,global.rxjs.operators,global.rxjs,global.ng.common,global.ng.core));
}(this, (function (exports,forms,operators,rxjs,common,i0) { 'use strict';
